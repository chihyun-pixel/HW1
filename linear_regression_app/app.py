...
a = st.sidebar.slider("Slope (a)", min_value=-20.0, max_value=20.0, value=2.0)
b = st.sidebar.slider("Intercept (b)", min_value=-20.0, max_value=20.0, value=1.0)
noise = st.sidebar.slider("Noise level", min_value=0.0, max_value=10.0, value=1.0)
n_points = st.sidebar.slider("Number of data points", min_value=5, max_value=200, value=20)
